...
if("TRUE" STREQUAL "TRUE")
  set(state_machine_SOURCE_PREFIX /home/gotvinne/Documents/autonomous_drones_ss2022/autonomous_drones_ws/src/state_machine)
  set(state_machine_DEVEL_PREFIX /home/gotvinne/Documents/autonomous_drones_ss2022/autonomous_drones_ws/devel/.private/state_machine)
  ...
  set(state_machine_INSTALL_PREFIX /home/gotvinne/Documents/autonomous_drones_ss2022/autonomous_drones_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'state_machine' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gotvinne/Documents/autonomous_drones_ss2022/autonomous_drones_ws/src/state_machine/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/gotvinne/Documents/autonomous_drones_ss2022/autonomous_drones_ws/devel/.private/state_machine/lib;/home/gotvinne/Documents/autonomous_drones_ss2022/autonomous_drones_ws/devel/lib;/opt/ros/noetic/lib)
