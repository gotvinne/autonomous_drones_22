...
struct NodeList_
{
  ...
  _stamp_type stamp;
   ...
   typedef std::vector< ::fla_msgs::NodeStatus_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::fla_msgs::NodeStatus_<ContainerAllocator> >::other >  _nodelog_type;
