...
struct Detection_
{
  ...
  _z_pos_type z_pos;
   ...
   typedef std::vector< ::fla_msgs::Keypoint_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::fla_msgs::Keypoint_<ContainerAllocator> >::other >  _kpts_type;
  _kpts_type kpts;
